...
local getCellTextSizes = function(propName, displayClassName, showClassName)
    local propNameTextSize = TextService:GetTextSize(propName, FONT_SIZE, FONT, Vector2.new(math.huge, math.huge))
    local classNameTextSize = showClassName and TextService:GetTextSize(displayClassName, FONT_SIZE, FONT, Vector2.new(math.huge, math.huge)) or Vector2.new()
...
PropertyListItem.render = function(self)
    ...
    return Roact.createElement("Frame", {
        ...
        ColorButtonContainer = Roact.createElement("Frame", {
            ...
            ColorButton = Roact.createElement("TextButton", {
...
PropertiesList.render = function(self)
    local theme = self.props.theme
    local ColorPane = self.props.ColorPane
    ...
    return Roact.createElement("ScrollingFrame", {
        ...
        TopImage = SCROLLBAR_IMAGES.Top,
        MidImage = SCROLLBAR_IMAGES.Middle,
        BottomImage = SCROLLBAR_IMAGES.Bottom,
...
PropertyListItem = RoactRodux.connect(function(store)
    return {
        theme = store.theme
    }
end)(PropertyListItem)
